...
<nav>
  ...
  <div class="container" style=" width: 1100px; ">
      ...
      <div class="row" >
          ...
          <div class="col s6 ">
              <img class="materialboxed" width="550" style="margin-left: 30px; " src="../imagenes/6.jpg">
 </div>
          <div class="col s6" style="width: 450px; margin-left: 100px; margin-top: 5px;" >        
              <h5 class="center blue darken-4 white-text" style="margin-left: -50px;height: 50px; padding-top: 10px; padding-bottom: 10px;margin-bottom: -10px; "><marquee>Misión</marquee></h5>
            
            <p class="card-panel large red lighten-3 " style="margin-left: -50px; text-align: justify; font-size: 16px;">
                La Unidad Educativa “CRISTOBAL DE TROYA " es formadora de estudiantes de calidad, al servicio de la sociedad; cuyo propósito es brindar una educación crítica, reflexiva, investigativa con calidad y calidez a través de la  práctica de valores y sobre todo que los estudiantes al término de su bachillerato se proyecten a la educación superior, para aplicar sus conocimientos científicos y competencias adquiridas en bien de la sociedad.
            </p>
